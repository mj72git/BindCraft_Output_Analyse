...
st.sidebar.caption("BOA v1.3.1")
st.sidebar.caption("")
st.sidebar.caption("The last modify : 10 Jan 2026")
...
if not st.session_state.analysis_done:
    ...
    if pdb_files and csv_file:
        ...
        if st.button("Run Analysis"):
            ...
            for col in ['Average_pLDDT','Average_i_pLDDT','Average_i_pAE']:
                if col not in df_rank.columns:
                    df_rank[col] = np.nan
            st.session_state.df_rank = df_rank.sort_values(by=['Average_pLDDT','Average_i_pLDDT','Average_i_pAE'], ascending=[False, False, True])
